...
from framedipt.tools.errors import MmcifParsingError
...
def parse(
    *, file_id: str, mmcif_string: str, catch_all_errors: bool = True
    ...
    try:
        ...
        mmcif_to_author_chain_id: dict[str, str] = {}
        seq_to_structure_mappings: dict[str, dict] = {}
        for atom in _get_atom_site_list(parsed_info):
            # We need to explicitly convert atom.model_num to string
            # because it is defined as int type,
            # however it's actually assigned with a string
            # because parsed_info contains strings.
            # And the type cannot be correctly inferred with the current implementation.
            if str(atom.model_num) != "1":
        ...
        for chain_id, seq_info in valid_chains.items():
            ...
            seq_str = "".join(seq)
            author_chain_to_sequence[author_chain] = seq_str
...
def _get_first_model(structure: PDB.Structure.Structure) -> PDB.Structure.Structure:
